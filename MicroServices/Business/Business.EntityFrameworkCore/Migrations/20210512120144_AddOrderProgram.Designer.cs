...
namespace Business.Migrations
{
    ...
    [Migration("20210512120144_AddOrderProgram")]
    partial class AddOrderProgram
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Business.Models.Craft.CraftNodeTextileProcessAssociation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Craft_CraftNodeTextileProcessAssociation", "dbo");
                });
            ...
            modelBuilder.Entity("Business.Models.Order.MachineCertificate", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Order_MachineCertificate", "dbo");
                });

            modelBuilder.Entity("Business.Models.Order.MachineCertificateRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("MachineCertificateId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("ProcessDispatchQueueId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("MachineCertificateId");

                    b.HasIndex("ProcessDispatchQueueId");

                    b.ToTable("Order_MachineCertificateRecord", "dbo");
                });
            ...
            modelBuilder.Entity("Business.Models.Order.OrderProgramRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<double?>("ExpectedOutput")
                        .HasColumnType("float");
                    ...
                    b.Property<double>("MergedOrderWeight")
                        .HasColumnType("float");
                    ...
                    b.ToTable("Order_OrderProgramRecord", "dbo");
                });

            modelBuilder.Entity("Business.Models.Order.ProcessDispatchQueue", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("AccomplishFlag")
                        .HasColumnType("int");

                    b.Property<DateTime?>("AccomplishTime")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("ApproximateStartTime")
                        .HasColumnType("datetime2");

                    b.Property<int>("ConfirmedFlag")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("LabTechnicianName")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<Guid?>("MaterialPreId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<double?>("MoistureRegain")
                        .HasColumnType("float");

                    b.Property<Guid?>("OrderProgramRecordId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("PrintedFlag")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MaterialPreId");

                    b.HasIndex("OrderProgramRecordId");

                    b.ToTable("ProcessDispatchQueues");
                });

            modelBuilder.Entity("Business.Models.Order.ProgramCraftItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Order_ProgramCraftItem", "dbo");
                });

            modelBuilder.Entity("Business.Models.Order.ProgramCraftItemRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ProgramCraftItemId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ProgramCraftItemId");

                    b.ToTable("Order_ProgramCraftItemRecord", "dbo");
                });
            ...
            modelBuilder.Entity("Business.Models.Craft.CraftNodeTextileProcessAssociation", b =>
                {
                    b.HasOne("Business.Models.Craft.CraftNodeList", "CraftNodeList")
                        .WithMany("CraftNodeTextileProcessAssociations")
            ...
            modelBuilder.Entity("Business.Models.Order.MachineCertificateRecord", b =>
                {
                    b.HasOne("Business.Models.Order.MachineCertificate", "MachineCertificate")
                        .WithMany()
                        .HasForeignKey("MachineCertificateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Business.Models.Order.ProcessDispatchQueue", "ProcessDispatchQueue")
                        .WithMany("MachineCertificateRecords")
                        .HasForeignKey("ProcessDispatchQueueId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.Navigation("MachineCertificate");

                    b.Navigation("ProcessDispatchQueue");
                });
            ...
            modelBuilder.Entity("Business.Models.Order.ProcessDispatchQueue", b =>
                {
                    ...
                    b.HasOne("Business.Models.Material", "MaterialPre")
                        .WithMany()
                        .HasForeignKey("MaterialPreId");

                    b.HasOne("Business.Models.Order.OrderProgramRecord", "OrderProgramRecord")
                        .WithMany()
                        .HasForeignKey("OrderProgramRecordId");

                    b.Navigation("MachineDocument");

                    b.Navigation("Material");

                    b.Navigation("MaterialPre");

                    b.Navigation("OrderProgramRecord");
                });
            ...
            modelBuilder.Entity("Business.Models.Order.ProgramCraftItemRecord", b =>
                {
                    b.HasOne("Business.Models.Order.ProcessDispatchQueue", "ProcessDispatchQueue")
                        .WithMany("ProgramCraftItemRecords")
                        .HasForeignKey("ProcessDispatchQueueId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Business.Models.Order.ProgramCraftItem", "ProgramCraftItem")
                        .WithMany()
                        .HasForeignKey("ProgramCraftItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ProcessDispatchQueue");

                    b.Navigation("ProgramCraftItem");
                });
            ...
            modelBuilder.Entity("Business.Models.Craft.CraftNodeList", b =>
                {
                    b.Navigation("CraftNodeTextileProcessAssociations");
                });
            ...
            modelBuilder.Entity("Business.Models.Order.ProcessDispatchQueue", b =>
                {
                    b.Navigation("MachineCertificateRecords");

                    b.Navigation("ProgramCraftItemRecords");
                });
