...
{
    public class JsMachineShiftReport : ShiftReportBase, IProductionCalculate, IProductionReport, IPowerReport
    {
        ...
        [Display(Name = "平均梳理速度(钳次/分)")]
        public int? AverageCardingSpeed { get; set; }
    }
}
